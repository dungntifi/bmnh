<p class="breadcumb">
    <?php if (function_exists('bcn_display')) {
        ...
        <?php if (is_tag()) { ?>
            <?php esc_html_e('Posts Tagged ', 'Flexible') ?><span class="raquo">&quot;</span><?php single_tag_title();
            echo('&quot;'); ?>
        <?php } elseif (is_day()) { ?>
        ...
        <?php } elseif (is_search()) { ?>
            <?php echo '<span>';esc_html_e('Search results for', 'Flexible') ?><?php the_search_query();echo '</span>'; ?>
        ...
        <?php } elseif (is_author()) { ?>
            ...
            ?>
            <?php esc_html_e('Posts by ', 'Flexible');
